...
:root {
  ...
  --secondary-color: #e74c3c;  /* Complementary Coral */
  --background-color: #d6eaf8; /* Light Sky Blue */
  --toc-background-color: #ebf5fb; /* Pale Blue */
  --toc-border-color: #48c9b0; /* Soft Teal */
}

/* Style the body with the new background color */
body {
  background-color: var(--background-color);
  color: #2c3e50; /* Dark gray-blue for text */
}

/* Style headers with the new primary color */
h1, h2, h3 {
  color: var(--primary-color);
}

/* Style the Table of Contents with new colors */
div.toc {
...
/* Style TOC headings with the new secondary color */
div.toc h2 {
  color: var(--secondary-color);
}

/* Style TOC links with the new primary color */
div.toc a {
  color: var(--primary-color);
  text-decoration: none;
}

/* Hover effect for TOC links with the new secondary color */
div.toc a:hover {
  color: var(--secondary-color);
...
An RMSE of 2.002811 indicates that, on average, the model's predictions are 2.002811 units away from their observed values. The model's goodness of fit based off the RMSE depends on the specifics of the data and the required precision of the problem, but with a range of 31.1 (in `mpg`), an RMSE of 2.002811 is considered relatively low. Therefore, our model has good predictive accuracy.
